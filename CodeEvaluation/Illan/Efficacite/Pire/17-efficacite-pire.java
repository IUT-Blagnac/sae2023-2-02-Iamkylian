...
public class Exercice {
    ...
    public static int compareWithOrder(String mot1, String mot2, List<Character> ordre) {
        ...
        for (int i = 0; i < longueurMotMin; i++) {
            ...
            if (char1 != char2) {
                ...
                if (index1 != -1 && index2 != -1) {
                    return Integer.compare(index1, index2); // ordre déterminé en fonction de l'index si les deux
                                                            // caractères sont présents dans l'ordre spécifié
                } else if (index1 != -1) {
        ...
        return Integer.compare(mot1.length(), mot2.length()); // si les préfixes sont identiques, la chaîne la plus
                                                              // courte est considérée inférieure
    }
