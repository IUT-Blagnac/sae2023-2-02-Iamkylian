...
public class Exercice {
     ...
     * @see <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">La meilleure
     *      solution</a>
    ...
    public static List<String> solution(String ordre, List<Character> inputString) {
        ...
        for (String 𝕚𝕟𝕥 : result) {
            oldordre[(inputString.contains(𝕚𝕟𝕥.charAt(0)) ? inputString.indexOf(𝕚𝕟𝕥.charAt(0))
                    : oldordre.length - 1)].add(𝕚𝕟𝕥);
