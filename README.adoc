...
| 1    | link:Phase2/src/main/SimpliciteMeilleur.java[simplicite-meilleur]| Java     | Simplicité | Meilleur
| 2    | link:src/main/java/exercice/Exercice2.java[simplicite-pire]    | Java     | Simplicité | Pire
| 3    | link:src/main/java/exercice/Exercice2.java[efficacite-meilleur]    | Java     | Efficacité | Meilleur
| 4    | link:src/main/java/exercice/Exercice2.java[efficacite-pire]    | Java     | Efficacité | Pire
| 5    | link:src/main/java/exercice/Exercice2.java[sobriete-meilleur]    | Java     | Sobriété | Meilleur
| 6    | link:src/main/java/exercice/Exercice2.java[sobriete-pire]    | Java     | Sobriété | Pire  
|==========================================================================
